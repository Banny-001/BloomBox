    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
              <a class="nav-link active" aria-current="page"   :active="request()->routeIs('bouquet')">
                {{ __('Bouquet') }}
            </a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="/essentials" role="button" data-bs-toggle="dropdown" aria-expanded="false">
             Essentials
            </a> 
         <ul class="dropdown-menu">
             ...
             <li> <a class="dropdown-item"  :active="request()->routeIs('items')">
                {{ __('Item') }}
             </li>
              <li><hr class="dropdown-divider"></li>
